...
> [!Note]
> Make sure you copy the token and store it somewhere safe and accessible, as it is only displayed once. If you lose it, you'll need to generate a new one by repeating the previous steps.
...
![Send Test Email](/images/delivery-connections/connect-cloudflare-with-fluentsmtp/send-test-email-10.webp)
