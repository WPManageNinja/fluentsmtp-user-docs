...
const FOOTER_TEXT = 'docs.fluentsmtp.com'
const DEFAULT_TITLE = 'FluentSMTP Documentation'
...
const SECTION_LABELS = {
  'obtain-smtp-credentials': 'Obtain SMTP Credentials'
}
...
const LOGO = {
  path: 'docs/public/images/brand/fluentSMTP_secondary_logo.webp',
  width: 340
}
...
const FLATTENED_SECTIONS = new Set(["getting-started","delivery-connections","obtain-smtp-credentials","advanced-functionalities","alerts","miscellaneous"])
